...
ifeq ($(TARGET_OS),qnx)
  $(info >>> WARNING - volumeRender is not supported on QNX - waiving sample <<<)
  SAMPLE_ENABLED := 0
endif
...
volumeRender.o:volumeRender.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

volumeRender_kernel.o:volumeRender_kernel.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

volumeRender: volumeRender.o volumeRender_kernel.o
...
clean:
	rm -f volumeRender volumeRender.o volumeRender_kernel.o
	rm -rf ./bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/volumeRender
